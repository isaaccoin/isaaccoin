...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Isaaccoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"vps-4286.gwhost.com", "vps-4388.gwhost.com"},
    {NULL, NULL}
};
...
unsigned int pnSeed[] =
{
   0xb9f483f1,0xb9f483dc,0xb9f48344
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Isaaccoin is probably already running."), addrBind.ToString().c_str());
        else
